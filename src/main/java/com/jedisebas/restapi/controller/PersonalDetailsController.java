...
public class PersonalDetailsController {
    ...
    @PatchMapping
    public List<PersonalDetailsDto> updateMany(@RequestBody final List<PersonalDetailsDto> personalDetailsDtoList) {
        return service.updateManyPersonalDetails(personalDetailsDtoList);
    }
}
